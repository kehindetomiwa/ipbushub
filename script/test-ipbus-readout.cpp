 ...
 */
 /**
 * Event parameter changed to period in seconds
 * 
 */
#include <iostream>
#include <ctime>
...
int main(int argc, const char* argv[]){
  ...
  if(argc<3){
    cout << "Usage: " << argv[0] << " <host> <addr> <smps> <period(s)> <port> <output-file>" << endl;
    return 0;
  }
  ...
  uint32_t perd = strtoul(argv[4],NULL,10);
